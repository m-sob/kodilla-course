...
public class ForumUserTestSuite {
    ...
    void testGetLocationsOfFriends() {
        ...
        //Then
        assertEquals(3, user1.getLocationsOfFrineds().size());
        assertTrue(user1.getLocationsOfFrineds().contains("Key West"));
        assertTrue(user1.getLocationsOfFrineds().contains("Washington"));
        assertTrue(user1.getLocationsOfFrineds().contains("Miami"));
        assertFalse(user1.getLocationsOfFrineds().contains("Orlando"));
